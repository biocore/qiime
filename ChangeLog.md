...
* Fixed bug in ``assign_taxonomy.py -m blast`` and ``parallel_assign_taxonomy_blast.py`` that prevented mutliple instances of either to run at that same time (see [#1786](https://github.com/biocore/qiime/issues/1768)).
