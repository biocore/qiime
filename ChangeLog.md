...
===================================================
* Added quality_filter_fasta.py, a companion script to demultiplex_fasta.py, which allows for quality filtering of reads (such as one would have with split_libraries.py) on post demultiplexed data.
