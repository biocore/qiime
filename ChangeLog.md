...
* Added new option --color_scheme to make_otu_heatmap.py to allow users to choose from different color schemes [here](http://wiki.scipy.org/Cookbook/Matplotlib/Show_colormaps).
