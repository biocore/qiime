...
* Refactored make_rarefaction_plots.py to add options: --generate_per_sample_plots & --generate_average_tables. 
* Refactored alpha_rarefaction.py to add option --retain_intermediate_files.
