...
=============================================
* ``observation_metadata_correlation.py`` has been added. This script allows the calculation of correlations between feature abundances and continuous-valued metadata. This script replaces the continuous-valued correlation function that was in ``otu_category_significance.py`` in QIIME 1.7 and earlier.
