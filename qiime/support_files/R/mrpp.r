# Runs vegan function mrpp on QIIME distance matrix
# usage:
# R --slave --args --source_dir $QIIME_HOME/qiime/support_files/R/ -d unifrac.txt -m Fasting_Map.txt -c Treatment -o mrpp < mrpp.r
#
# print help string:
# R --slave --args -h --source_dir $QIIME_HOME/qiime/support_files/R/ < mrpp.r
#
...
# run mrpp
results <- mrpp(dat=as.dist(qiime.data$distmat),
