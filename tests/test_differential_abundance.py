...
class RDifferentialAbundanceTests(TestCase):
    ...
    def test_metagenomeSeq_fitZIG_format(self):
        ...
        exp = ['3060\t0\t6\t0\t13\t0\t0\t0.701239961\t0.014906832\t0.028666985\t0.595803478\t2.121007454\t-49.29398614\t0.00095899345017\t0.01852846\tBv; other\n',
        ...
        #test first five significant OTUs
        exp = ['3060\t0\t6\t0\t13\t0\t0\t0.701239961\t0.014906832\t0.028666985\t0.595803478\t2.121007454\t-49.29398614\t0.00095899345017\t0.01852846\n',
