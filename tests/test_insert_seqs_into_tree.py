...
class Tests(TestCase):
    ...
    def setUp(self):
        ...
        self.align_map = {
            ...
            'seq0000007': 'Species007',
            'seq0000006': 'Species006',
            'seq0000001': 'Species001',
            'seq0000003': 'Species003',
...
class insertSeqsTests(Tests):
    ...
    def test_strip_and_rename_unwanted_labels_from_tree(self):
        ...
        # parse and load tree
        result = DndParser(
            StringIO(RESULTING_QUERY_TREE),
            constructor=PhyloNode)

        # strip and rename tips
        result_tree = strip_and_rename_unwanted_labels_from_tree(
            self.align_map,
            result)
