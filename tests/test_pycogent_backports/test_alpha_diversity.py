...
class diversity_tests(TestCase):
    ...
    def test_kempton_taylor_q(self):
        ...
        c = array(
            [2, 3, 3, 3, 3, 3, 4, 4, 4, 6, 6, 7, 7, 9, 9, 11, 14, 15, 15, 20, 29, 33, 34,
    ...
    def test_ACE(self):
        ...
        self.assertFloatEqual(
            ACE(array([12, 3, 6, 1, 10])), 5.62749672, eps=0.001)
    ...
    def test_enspie(self):
        ...
        # example1 - totally even community shoudl have ENS_pie=number of
        # species
        c = array([1, 1, 1, 1, 1, 1])
    ...
    def test_esty_ci(self):
        ...
        expected_upper = [1, 1.38590382, 1.40020259, 0.67434465, 0.55060902,
                          ...
                          0.53385652]
        expected_lower = [
            1, -1.38590382, -0.73353593, -0.17434465, -0.15060902,
