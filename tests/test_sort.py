...
class SortTests(TestCase):
    ...
    def test_sort_otu_table_all_values_differ(self):
        """ sort_otu_table functions as expected when all values differ"""
    ...
    def test_sort_otu_table_some_values_differ(self):
        """ sort_otu_table functions as expected when some values differ"""
    ...
    def test_sort_otu_table_some_values_same(self):
        """ sort_otu_table functions as expected when all values are the same"""
