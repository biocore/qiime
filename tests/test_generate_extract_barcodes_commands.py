...
class GenerateJoinPairedEndsCommands(TestCase):
    ...
    def test_create_commands(self):
        ...
        commands = create_commands(pairs, ispaired, base_output_dir,
        ...
        expected_commands = set(['extract_barcodes.py  -f f_read1.fastq -r r_read1.fastq -o output_dir/f_read1 ',
            'extract_barcodes.py  -f f_read2.fastq -r r_read2.fastq -o output_dir/f_read2 '])
            
        self.assertEqual(actual_commands, expected_commands)
        
    def test_create_commands_unpaired(self):
        """ Properly creates commands """
