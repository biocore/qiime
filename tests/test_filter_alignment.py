...
class FilterAlignmentTests(TestCase):
    ...
    def test_freqs_from_aln_array(self):
        ...
        assert_almost_equal(results[t_index], t_expected)
        assert_almost_equal(results[c_index], c_expected)
        assert_almost_equal(results[a_index], a_expected)
        assert_almost_equal(results[g_index], g_expected)
        assert_almost_equal(results[gap_index], gap_expected)
