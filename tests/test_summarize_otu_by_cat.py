...
7.69231\t16.66667\t0.0"""
	...
	def test_parse_map(self):
		"""parse_map should return hand calculated values"""
		cat_by_sample, sample_by_cat, num_cats, meta_dict,label_lists_dict,num_samples_by_cat = parse_map(self.map_file.split('\n'),"Day")
	...
	def test_parse_otu_sample(self):
		"""parse_otu_sample should return hand calculated values"""
		cat_otu_table, otus, taxonomy = parse_otu_sample(\
