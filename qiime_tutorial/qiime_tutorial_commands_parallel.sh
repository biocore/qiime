...
rm -rf wf_arare ; alpha_rarefaction.py -i wf_da/otu_table.txt -m Fasting_Map.txt -o wf_arare/ -p custom_parameters.txt -t wf_da/rep_set.tre -a

echo "Beta diversity, 3d plots"
rm -rf wf_bdiv_even146 ; beta_diversity_through_3d_plots.py -i wf_da/otu_table.txt -m Fasting_Map.txt -o wf_bdiv_even146/ -p custom_parameters.txt -t wf_da/rep_set.tre -a -e 146
...
rm -rf wf_jack ; jackknifed_beta_diversity.py -i wf_da/otu_table.txt -o wf_jack -p custom_parameters.txt -e 110 -t wf_da/rep_set.tre -a -m Fasting_Map.txt
