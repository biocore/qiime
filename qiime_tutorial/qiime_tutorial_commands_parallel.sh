...
rm -rf wf_bdiv_even146 ; beta_diversity_through_plots.py -i wf_da/otu_table.txt -m Fasting_Map.txt -o wf_bdiv_even146/ -p custom_parameters.txt -t wf_da/rep_set.tre -a -e 146
