...
Run beta diversity with Unweighted UniFrac, Weighted UniFrac, Bray-Curtis, and Euclidean distance metrics, and alpha diversity with Observed Species and Chao1. This can be used with `beta_diversity_through_plots.py <../scripts/beta_diversity_through_plots.html>`_, `alpha_rarefaction.py  <../scripts/alpha_rarefaction.html>`_, and `core_diversity_analyses.py <../scripts/core_diversity_analyses.html>`_.
::
