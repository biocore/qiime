 ...
 * Stable Release: Currently the most stable version of QIIME is our 1.2.1 release, which you can `download here <http://sourceforge.net/projects/qiime/files/releases/Qiime-1.2.1.tar.gz/download>`_.
