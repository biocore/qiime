...
This tutorial is provided as an IPython Notebook. See the `Illumina Overview Tutorial IPython Notebook <http://nbviewer.ipython.org/urls/github.com/qiime/qiime/raw/1.7.0/examples/ipynb/illumina_overview_tutorial.ipynb>`_. 
