...
.. note::
	...
	**[OPTIONAL]**
	...
	-e, `-`-error_profile
		Path to error profile [default= $HOME/qiime_software/qiime/support_files/denoiser/Data/FLX_error_profile.dat]
	`-`-titanium
		Shortcut for -e $HOME/qiime_software/qiime/support_files/denoiser/Data//Titanium_error_profile.dat --low_cut-off=4 --high_cut_off=5 . Warning: overwrites all previous cut-off values [DEFAULT: False]
