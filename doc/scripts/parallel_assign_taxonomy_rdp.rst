...
.. note::
	...
	**[OPTIONAL]**
	...
	`-`-rdp_classifier_fp
		Full path to rdp classifier jar file [default: /Users/caporaso/Dropbox/bin/rdp_classifier_2.2/rdp_classifier-2.2.jar]
	-c, `-`-confidence
	...
	-r, `-`-reference_seqs_fp
		Ref seqs to rdp against. [default: /Users/caporaso/.virtualenvs/qiime/lib/python2.7/site-packages/qiime_default_reference/gg_13_8_otus/rep_set/97_otus.fasta]
	`-`-rdp_max_memory
