...
.. note::
	...
	**[OPTIONAL]**
	...
	-N, `-`-identify_chimeric_seqs_fp
		Full path to scripts/`identify_chimeric_seqs.py <./identify_chimeric_seqs.html>`_ [default: /Qiime/scripts/`identify_chimeric_seqs.py <./identify_chimeric_seqs.html>`_]
	-O, `-`-jobs_to_start
