...
::
	...
	plot_rank_abundance_graph.py -i otu_table.biom  -s 'PC.354' -x -v -o single_plot/
...
::
	...
	plot_rank_abundance_graph.py -i otu_table.biom  -s 'PC.354,PC.481,PC.636' -x -v -o multi_plot/
...
::
	...
	plot_rank_abundance_graph.py -i otu_table.biom  -s '*' -x -f eps -v -o all_plot/
