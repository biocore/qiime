...
.. note::
	...
	**[REQUIRED]**
	...
	-e, `-`-sampling_depth
		Sequencing depth to use for even sub-sampling and maximum rarefaction depth. You should review the output of `print_biom_table_summary.py <http://biom-format.org/documentation/summarizing_biom_tables.html>`_ to decide on this value.
