...
script_info = {}
script_info[
    'brief_description'] = "Simulate samples for each sample in an OTU table, using a phylogenetic tree."
...
script_info['script_usage'].append(
    ("",
     ...
     "%prog -i otu_table.biom -t rep_set.tre -o simsam_out2 -d .001,.01 -n 2,3,4 -m map.txt"))
...
script_info['required_options'] = [
    ...
    make_option(
        '-d',
        '--dissim',
        help='dissimilarity between nodes up the tree, as a single value or comma-separated list of values'),
    make_option('-n', '--num',
