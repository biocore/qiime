...
In addition, the files generated by formatdb will be kept in the same directory as subjectdb, unless the --clean option is passed, in which case they will be removed.
"""
...
script_info['optional_options']=[\
    ...
    make_option("-c","--clean",action = 'store_true',\
        dest='clean',default = False,\
        help="If set, delete files generated by formatdb [DEFAULT: %default]"),\
    ...
    make_option("-n","--no_format_db",dest = 'format_db', action = "store_false",\
        default = True,\
