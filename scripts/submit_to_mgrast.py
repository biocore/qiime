...
script_info = {}
script_info[
    'brief_description'] = "This script submits a FASTA file to MG-RAST"
script_info[
...
script_info[
    'output_description'] = "The resulting directory will contain all of the sample-separated FASTA files, along with a log html file, which informs the user of the jobs started on MG-RAST"
script_info['required_options'] = [
    ...
    make_option(
        ...
        help='the web services authorization key from MG-RAST'),
    make_option(
        '-p',
        '--project_id',
        type='string',
        help='the title to be used for the project'),
