...
script_usage = """
Example 1: Compare two pca/pcoa files in the same 3d plot where each ID is colored:

Usage: python make_3d_plots.py -i 'raw_pca_data1.txt,raw_pca_data2.txt'

Example 2: Compare two pca/pcoa files in the same 3d plot with two coloring
schemes (Day and Type):

Usage: python make_3d_plots.py -i 'raw_pca_data1.txt,raw_pca_data2.txt' -m input_map.txt -b 'Day,Type'

Example 3: Compare two pca/pcoa files in the same 3d plot for a combination 
of label headers from a mapping file:

Usage: python make_3d_plots.py -i 'raw_pca_data1.txt,raw_pca_data2.txt' -m input_map.txt 
-b 'Type&&Day' -o ./test/
