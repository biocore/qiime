...
script_info = {}
script_info[
    'brief_description'] = """Plot several PCoA files on the same 3D plot"""
...
script_info['script_usage'].append(
    ("Example 1",
     ...
     """%prog -i $PWD/raw_pca_data1.txt,$PWD/raw_pca_data2.txt -m $PWD/Fasting_Map.txt"""))
script_info['script_usage'].append(
    ("Example 2",
     """Compare two pca/pcoa files in the same 3d plot with two coloring schemes (Treatment and DOB):""",
     """%prog -i $PWD/raw_pca_data1.txt,$PWD/raw_pca_data2.txt -m $PWD/Fasting_Map.txt -b 'Treatment,DOB'"""))
script_info['script_usage'].append(
    ("Example 3",
     """Compare two pca/pcoa files in the same 3d plot for a combination of label headers from a mapping file: """,
     """%prog -i $PWD/raw_pca_data1.txt,$PWD/raw_pca_data2.txt -m $PWD/Fasting_Map.txt -b 'Treatment&&DOB' -o $PWD/test/"""))
script_info['script_usage'].append(
    ("Example 4",
     """Pass in a list of desired edges and only one pca/pcoa file: """,
     """%prog -i $PWD/raw_pca_data1.txt -e $PWD/edges.txt -m Fasting_Map.txt -b 'Treatment&&DOB' -o $PWD/test2/"""))
script_info['script_usage'].append(
    ("Example 5",
     """Pass in a list of desired edges and only one pca/pcoa file: """,
     """%prog -i $PWD/raw_pca_data1.txt,$PWD/raw_pca_data2.txt -e $PWD/edges.txt -m $PWD/Fasting_Map.txt -b 'Treatment&&DOB' -o $PWD/test3/"""))
script_info[
    'output_description'] = """This script results in a folder containing an html file which displays the 3D Plots generated."""
...
analysis. See make_prefs_file.py. [default: %default]', type='existing_filepath'),
    make_option(
        '-k', '--background_color', type='choice', choices=['black', 'white'],
