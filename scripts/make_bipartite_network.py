...
script_info = {}
script_info['brief_description'] = """This script makes a bipartite network connecting samples to observations. It is most suitable for visualization with cytoscape."""
...
script_info['required_options'] = [\
 ...
 make_option('-o','--output_dir',type="new_dirpath",help='directory that ' +\
    'will be created for storing the results.'),
 make_option('-k','--observation_md_header_key',type="string",
    help='Key to retrieve metadata (usually taxonomy) from the biom file. '
    'Currently only one-to-one relationships are supported; please see the '
    'full script description for details'),
 make_option('--md_fields',type="string",help='metadata fields that will be '+\
    'the headers of the OTUNodeTable. If the biom table has ' +\
    'metadata dictionaries, md_fields will be the keys extracted from the ' +\
    'biom table metadata. Passed like "kingdom,phylum,class".')]
script_info['optional_options'] = [\
 ...
 make_option('--ocolors',type="string",help='commas separated string ' +\
    'specifying fields of interest for observation node coloring [default: %default].',
    default='NodeType'),
 ...
 make_option('--oshapes',type="string",help='commas separated string ' +\
    'specifying fields of interest for observation node shape [default: %default].',
    default='NodeType'),
 ...
 make_option('--osizes',type="string",help='commas separated string ' +\
    'specifying fields of interest for observation node size [default: %default].',
    default='NodeType')]
