...
script_info['script_description']=(
    "This script provides a convenient interface for merging mapping files "
    "which contains data on different samples.")

script_info['script_usage']=[]
script_info['script_usage'].append(
    ("Example:",
    "Merge two mapping files into a new mapping file (merged_mapping.txt). "
    "In cases where a mapping field is not provided for some samples, add the "
...
script_info['optional_options']=[
    make_option('-n',
                ...
                'fields are not defined in all mapping files) '
                '[default: %default]',
                default='no_data')
]
