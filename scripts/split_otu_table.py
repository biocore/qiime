...
script_info = {}
script_info[
    'brief_description'] = "Split in a single OTU table into one OTU table per value in a specified field of the mapping file."
...
script_info['required_options'] = [
    ...
    make_option(
        ...
        '--mapping_field',
        type='string',
        help="mapping column to split otu table on"),
    make_option(
        '-o',
        '--output_dir',
        type="new_dirpath",
