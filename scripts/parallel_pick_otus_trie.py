...
script_info['script_usage'].append(("""Example""","""Pick OTUs by building a trie out of $PWD/inseqs.fasta and write the output to the $PWD/trie_otus/ directory. Split the input according to the first 5 bases of each read and process each set independently.""","""%prog -i $PWD/seqs.fna -o $PWD/trie_otus/ -p 5"""))
...
script_info['optional_options'] = [\
    make_option('-p','--prefix_length',action='store',\
                    type='int',help='prefix length used to split the input. Must be smaller than the shortest seq in input!',\
                    default=1),\
